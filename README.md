...
# Set your OpenCode API key. Defaults to opencode-go/deepseek-v4-flash.
...
By default, this deployment sets `SANDBOX_SLEEP_AFTER=30m` as a plaintext Wrangler variable so the sandbox sleeps after 30 minutes of inactivity. Set it to `never` if you prefer to keep the container alive indefinitely; cold starts can take 1-2 minutes.
